...
import { Activity, ArrowLeft, ArrowRight, CheckCircle2, Shield, User } from "lucide-react"
        ...
        <section className="max-w-7xl mx-auto px-6 pt-14 pb-10">
            <div className="max-w-3xl">
                ...
                <p className="text-stone-500 text-base sm:text-lg leading-relaxed">
                    Review life insurance plans with premiums, coverage amounts, and the benefits included in each policy.
            </p>
            </div>
        </section>
