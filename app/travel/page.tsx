...
import { TravelHero } from "@/app/travel/component/TravelHero";
import { TravelBenefits } from "@/app/travel/component/TravelBenefits";
import { TravelFilter } from "@/app/travel/component/TravelFilter";
import { TravelPolicyCard } from "@/app/travel/component/TravelPolicyCard";

const travelPolicies = [
  {
    id: "1",
    company: "HDFC Ergo",
    plan: "International Travel Protect",
    premium: "₹899",
    coverage: "₹50 Lakh",
  },
  {
      ...
      <div className="max-w-7xl mx-auto px-6 py-10">
        ...
        <div className="grid gap-6 mt-8 md:grid-cols-2 lg:grid-cols-3">
          {travelPolicies.map((policy) => (
            <TravelPolicyCard key={policy.id} policy={policy} />
          ))}
        </div>
      </div>
    </main>
