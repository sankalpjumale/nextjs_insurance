        ...
        <main className="min-h-screen bg-[#f7f5f0]">
            ...
            <section className="max-w-7xl mx-auto px-6 pt-14 pb-10">
                <div className="max-w-3xl">
                    <div className="inline-flex items-center gap-2 bg-sky-50 text-sky-700 text-xs font-semibold px-3 py-1.5 rounded-full mb-5 border border-sky-100">
                    ...
                    <p className="text-stone-500 text-base sm:text-lg leading-relaxed">
                        Review policies that protect your house and belongings against damage, theft, fire, and natural events.
                    </p>
                </div>
            </section>
            ...
            <section className="max-w-7xl mx-auto px-6 pb-20">
                {policies.length === 0 ? (
                    <div className="flex flex-col items-center justify-center py-28 text-center border-2 border-dashed border-stone-200 rounded-2xl">
                        ...
                        <p className="text-stone-500 text-lg font-semibold">No home policies found</p>
                        <p className="text-stone-400 text-sm mt-1">Run the seed script to add sample home policies.</p>
                    </div>
                ) : (
                    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                        {policies.map((policy) => (
                            ...
                            >
                                <div className="h-1.5 w-full bg-gradient-to-r from-sky-400 via-cyan-400 to-indigo-400" />
                                <div className="p-6 flex flex-col flex-1">
                                    <div className="flex items-start justify-between gap-4 mb-5">
                                        <span className="inline-flex items-center gap-1.5 text-xs font-semibold px-2.5 py-1 rounded-full bg-sky-50 text-sky-700">
